<?php
/**
 * A Stack class to replace SilverStripe's Requirements class for the front end.
 *
 * This has been modelled strongly on Habari's stack class.
 *
 * <code>
 * // Add jquery to the javascript stack:
 * Stack::add( 'template_header_javascript', Director::absoluteBaseURL . 'mysite/javascript/jquery.js', 'jquery' );
 *
 * // Add stylesheet to theme_stylesheet stack with media type
 * Stack::add( 'template_stylesheet', Director::absoluteBaseURL() . 'themes/' . SSViewer::current_theme() . '/css/style.css', 'screen' ), 'style' );
 */
class Stack
{
